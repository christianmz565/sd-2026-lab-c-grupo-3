...
export default function () {
  ...
  const res = http.get(`${BASE_URL}/api/books/${id}`);
  ...
  check(res, {
    ...
    'response has book fields': (r) => {
      try {
        ...
        return body.title && body.author && body.isbn;
      } catch (e) {
        return false;
      }
    },
...
export function handleSummary(data) {
  ...
  return {
    '/tmp/opencode/rest_get_one_results.json': JSON.stringify({
      test: 'REST GET Single Book',
