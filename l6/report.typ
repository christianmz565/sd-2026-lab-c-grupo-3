...
#show: unsa-report.with(
  ...
  lab_title: "REST vs. RESTful: Diseño e Implementación de Servicios Distribuidos",
  lab_number: "06",
...
#lab-section(title: "RESULTADOS Y PRUEBAS")[
  ...
  #code-block(
    file: "l6/snippets/s1/index.html",
    snippet: "fetch",
    lang: "javascript",
    prefix: "//",
  )
  ...
  #code-block(
    file: "l6/snippets/e1/BookApiController.java",
...
#lab-section(title: "ANEXOS")[
  ...
  #code-block(file: "l6/src/e1/src/main/java/com/lab06/e1/E1Application.java")

  === Modelo del Libro (Entidad JPA)
  #code-block(file: "l6/src/e1/src/main/java/com/lab06/e1/model/Book.java")

  === Repositorio de Libros (Spring Data JPA)
  #code-block(file: "l6/src/e1/src/main/java/com/lab06/e1/repository/BookRepository.java")

  === Controlador de la API REST
  #code-block(file: "l6/src/e1/src/main/java/com/lab06/e1/controller/BookApiController.java")

  === Configuración CORS (WebConfig)
  #code-block(file: "l6/src/e1/src/main/java/com/lab06/e1/config/WebConfig.java")

  === Poblado Inicial de Base de Datos (DatabaseSeeder)
  #code-block(file: "l6/src/e1/src/main/java/com/lab06/e1/config/DatabaseSeeder.java")

  == Ejercicio 2: API RESTful Estudiantes (Python + Flask)

  === Archivo Principal de Inicio (main.py)
  #code-block(file: "l6/src/e2/main.py", lang: "python")

  === Inicialización de la Aplicación y SQLAlchemy (`__init__.py`)
  #code-block(file: "l6/src/e2/app/__init__.py", lang: "python")

  === Modelo del Estudiante (SQLAlchemy)
  #code-block(file: "l6/src/e2/app/models.py", lang: "python")

  === Definición de Rutas de la API (routes.py)
  #code-block(file: "l6/src/e2/app/routes.py", lang: "python")

  === Script Cliente de Pruebas (cliente.py)
  #code-block(file: "l6/src/e2/cliente.py", lang: "python")
]
