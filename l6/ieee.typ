...
#let ieee(
  ...
  show heading: it => {
    ...
    if it.level == 1 {
      ...
      let is-ack = it.body in ([Acknowledgment], [Acknowledgement], [Acknowledgments], [Acknowledgements], [Agradecimientos], [Agradecimiento])
      set align(center)
  ...
  if abstract != none {
    ...
    [_Resumen_---#h(weak: true, 0pt)#abstract]

    if index-terms != () {
      parbreak()
      [_Palabras clave_---#h(weak: true, 0pt)#index-terms.join[, ]]
    }
    v(2pt)
  }
