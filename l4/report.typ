...
#show: unsa-report.with(
  ...
  lab_title: "Programación Distribuida en Java con RMI (Invocación Remota de Métodos)",
  lab_number: "04",
...
#lab-section(title: "RESULTADOS Y PRUEBAS")[
  ...
  #code-block(
    file: "l4/snippets/s1/CalculatorServer.java",
    snippet: "server-bind",
  )
  ...
  #code-block(
    file: "l4/snippets/s1/CalculatorClient.java",
  ...
  #code-block(
    file: "l4/snippets/e1/Medicine.java",
  ...
  #code-block(
    file: "l4/snippets/e1/Stock.java",
    snippet: "stock-impl",
  )
  ...
  #code-block(
    file: "l4/snippets/e1/ServerSide.java",
  ...
  #code-block(
    file: "l4/snippets/e1/ClienteSide.java",
    snippet: "client-menu",
  )
  ...
  #code-block(
    file: "l4/snippets/e2/CreditCardImpl.java",
    snippet: "card-impl",
  )
  ...
  #code-block(
    file: "l4/snippets/e2/CreditServer.java",
    snippet: "card-server",
  )
  ...
  #code-block(
    file: "l4/snippets/e2/CreditClient.java",
    snippet: "card-client",
  )
  ...
  #code-block(
    file: "l4/snippets/e3/CurrencyImpl.java",
  ...
  #code-block(
    file: "l4/snippets/e3/CurrencyServer.java",
  ...
  #code-block(
    file: "l4/snippets/e3/CurrencyClient.java",
...
#lab-section(title: "ANEXOS")[
  ...
  #code-block(file: "l4/src/e1/MedicineInterface.java")

  === Implementación de Medicina
  #code-block(file: "l4/src/e1/Medicine.java")

  === Interfaz de Stock
  #code-block(file: "l4/src/e1/StockInterface.java")

  === Implementación de Stock
  #code-block(file: "l4/src/e1/Stock.java")

  === Excepción de Stock
  #code-block(file: "l4/src/e1/StockException.java")

  === Servidor de Farmacia
  #code-block(file: "l4/src/e1/ServerSide.java")

  === Cliente de Farmacia
  #code-block(file: "l4/src/e1/ClienteSide.java")

  == Ejercicio 2: Sistema de Tarjetas de Crédito

  === Interfaz de Tarjeta de Crédito
  #code-block(file: "l4/src/e2/CreditCardInterface.java")

  === Implementación de Tarjeta de Crédito
  #code-block(file: "l4/src/e2/CreditCardImpl.java")

  === Servidor de Tarjetas de Crédito
  #code-block(file: "l4/src/e2/CreditServer.java")

  === Cliente de Tarjetas de Crédito
  #code-block(file: "l4/src/e2/CreditClient.java")

  == Ejercicio 3: Servicio de Conversión de Moneda

  === Interfaz de Conversión de Moneda
  #code-block(file: "l4/src/e3/CurrencyInterface.java")

  === Implementación de Conversión de Moneda
  #code-block(file: "l4/src/e3/CurrencyImpl.java")

  === Servidor de Conversión de Moneda
  #code-block(file: "l4/src/e3/CurrencyServer.java")

  === Cliente de Conversión de Moneda
  #code-block(file: "l4/src/e3/CurrencyClient.java")

  == Ejemplo de RMI en Java: Calculadora

  === Interfaz de Calculadora
  #code-block(file: "l4/src/s1/Calculator.java")

  === Implementación de Calculadora
  #code-block(file: "l4/src/s1/CalculatorImpl.java")

  === Servidor de Calculadora
  #code-block(file: "l4/src/s1/CalculatorServer.java")

  === Cliente de Calculadora
  #code-block(file: "l4/src/s1/CalculatorClient.java")
]
