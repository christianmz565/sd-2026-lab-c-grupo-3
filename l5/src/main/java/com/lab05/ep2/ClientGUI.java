...
public class ClientGUI extends JFrame {
  ...
  private ConverterServiceGrpc.ConverterServiceBlockingStub stub;
  ...
  private final Map<Integer, Integer> listIndexToConversion =
    new LinkedHashMap<>();
  ...
  private JPanel buildLeftPanel() {
    ...
    conversionList.addMouseListener(
      new MouseAdapter() {
        @Override
        public void mouseClicked(MouseEvent e) {
          int idx = conversionList.locationToIndex(e.getPoint());
          if (
            idx >= 0 && listModel.get(idx).startsWith("§")
    ...
    new SwingWorker<Boolean, Void>() {
      ...
      protected Boolean doInBackground() {
        try {
          ...
          channel = ManagedChannelBuilder.forAddress("localhost", 50051)
            .usePlaintext()
            .build();
          stub = ConverterServiceGrpc.newBlockingStub(channel);
          // Prueba rápida
      ...
      protected void done() {
        ...
        if (connected) {
          ...
          appendHistory(
            "✗ No se pudo conectar. Verifica que el servidor esté activo."
          );
        }
      }
    }.execute();
  ...
  private void doConvert() {
    ...
    new SwingWorker<GRPCResult, Void>() {
      @Override
      protected GRPCResult doInBackground() throws Exception {
  ...
  private GRPCResult callGRPC(int convIdx, ConvertRequest req) {
    ...
    switch (convIdx) {
      case 0:
        resp = stub.convertCelsiusToFahrenheit(req);
        break;
      case 1:
        resp = stub.convertFahrenheitToCelsius(req);
        break;
      case 2:
        resp = stub.convertSolesToDollars(req);
        break;
      case 3:
        resp = stub.convertDollarsToSoles(req);
        break;
      case 4:
        resp = stub.convertKmToMiles(req);
        break;
      case 5:
        resp = stub.convertMilesToKm(req);
        break;
      case 6:
        resp = stub.convertKgToLbs(req);
        break;
      case 7:
        resp = stub.convertLbsToKg(req);
        break;
      case 8:
        resp = stub.convertHoursToMinutes(req);
        break;
      case 9:
        resp = stub.convertMinutesToHours(req);
        break;
      default:
        throw new IllegalStateException("Índice inválido: " + convIdx);
    }
